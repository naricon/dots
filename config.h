...
static const uint16_t movements[] = {1,50,15,400};
...
static const uint8_t borders[] = {4,6,10,6};
...
static const char *term[]      = { "st", "-G", "400x250", NULL };
///--Custom foo---///
...
static key keys[] = {
    ...
    {  MOD |ALT,          XK_k,          resizestep,        {.i=TWOBWM_RESIZE_UP_SLOW}},
    {  MOD |ALT,          XK_j,          resizestep,        {.i=TWOBWM_RESIZE_DOWN_SLOW}},
    {  MOD |ALT,          XK_l,          resizestep,        {.i=TWOBWM_RESIZE_RIGHT_SLOW}},
    {  MOD |ALT,          XK_h,          resizestep,        {.i=TWOBWM_RESIZE_LEFT_SLOW}},
    // Resize a window
    {  MOD |SHIFT|ALT,    XK_k,          resizestep,        {.i=TWOBWM_RESIZE_UP}},
    {  MOD |SHIFT|ALT,    XK_j,          resizestep,        {.i=TWOBWM_RESIZE_DOWN}},
    {  MOD |SHIFT|ALT,    XK_l,          resizestep,        {.i=TWOBWM_RESIZE_RIGHT}},
    {  MOD |SHIFT|ALT,    XK_h,          resizestep,        {.i=TWOBWM_RESIZE_LEFT}},
    ...
    // Center x:
    {  MOD |ALT,          XK_g,          teleport,          {.i=TWOBWM_TELEPORT_CENTER_X}},
    // Top left:
